...
/**
 * Provides the local service interface for BigTitle. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BigTitleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BigTitleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.samples.fbo.big.titles.service.impl.BigTitleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the big title local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BigTitleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BigTitle upsertBigTitle(
